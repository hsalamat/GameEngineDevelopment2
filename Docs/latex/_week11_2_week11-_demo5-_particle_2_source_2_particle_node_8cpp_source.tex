...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00020}00020     , mTexture(\mbox{\hyperlink{enum_demo1_8cpp_ac6a70fa2f77cc3032c1eea5a4c725cff}{textures}}.get(\mbox{\hyperlink{namespace_textures}{Textures}}::\mbox{\hyperlink{struct_particle}{Particle}}))}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00032}00032     particle.\mbox{\hyperlink{struct_particle_ac4b0b63df626ccb45334c7df7a6ca446}{color}} = Table[mType].color;}
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00033}00033     particle.\mbox{\hyperlink{struct_particle_a160dfae711f857869ddf279cc745a350}{lifetime}} = Table[mType].lifetime;}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00036}00036     mParticles.push\_back(particle);}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00041}00041     \textcolor{keywordflow}{return} mType;}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00049}00049 \textcolor{keywordtype}{void} ParticleNode::updateCurrent(\mbox{\hyperlink{classsf_1_1_time}{sf::Time}} dt, \mbox{\hyperlink{class_command_queue}{CommandQueue}}\&)}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00052}00052     \textcolor{keywordflow}{while} (!mParticles.empty() \&\& mParticles.front().lifetime <= \mbox{\hyperlink{classsf_1_1_time_aa343e67f43a940e7b3b51aa10a495f2f}{sf::Time::Zero}})}
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00053}00053         mParticles.pop\_front();  \textcolor{comment}{//older particles are in the front of queue and expire first}}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00056}00056     \textcolor{keywordflow}{for} (\mbox{\hyperlink{struct_particle}{Particle}}\& particle : mParticles)}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00059}00059     mNeedsVertexUpdate = \textcolor{keyword}{true};}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00064}00064     \textcolor{keywordflow}{if} (mNeedsVertexUpdate)}
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00065}00065     \{}
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00066}00066         computeVertices();}
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00067}00067         mNeedsVertexUpdate = \textcolor{keyword}{false};}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00071}00071     states.\mbox{\hyperlink{classsf_1_1_render_states_ad7eb50453917561fa7a9df7f4c53f1fd}{texture}} = \&mTexture;}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00074}00074     target.\mbox{\hyperlink{classsf_1_1_render_target_a12417a3bcc245c41d957b29583556f39}{draw}}(mVertexArray, states);}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00084}00084     mVertexArray.\mbox{\hyperlink{classsf_1_1_vertex_array_a80c8f6865e53bd21fc6cb10fffa10035}{append}}(vertex);}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00087}00087 \textcolor{keywordtype}{void} ParticleNode::computeVertices()\textcolor{keyword}{ const}}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00090}00090     \mbox{\hyperlink{classsf_1_1_vector2}{sf::Vector2f}} size(mTexture.\mbox{\hyperlink{classsf_1_1_texture_a9f86b8cc670c6399c539d4ce07ae5c8a}{getSize}}());}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00094}00094     mVertexArray.\mbox{\hyperlink{classsf_1_1_vertex_array_a3654c424aca1f9e468f369bc777c839c}{clear}}();}
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00095}00095     \textcolor{keywordflow}{for} (\textcolor{keyword}{const} \mbox{\hyperlink{struct_particle}{Particle}}\& particle : mParticles)}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00100}00100         \textcolor{keywordtype}{float} ratio = particle.lifetime.asSeconds() / Table[mType].lifetime.asSeconds();}
...
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00106}00106         addVertex(pos.\mbox{\hyperlink{classsf_1_1_vector2_a1e6ad77fa155f3753bfb92699bd28141}{x}} + half.\mbox{\hyperlink{classsf_1_1_vector2_a1e6ad77fa155f3753bfb92699bd28141}{x}}, pos.\mbox{\hyperlink{classsf_1_1_vector2_a420f2481b015f4eb929c75f2af564299}{y}} -\/ half.\mbox{\hyperlink{classsf_1_1_vector2_a420f2481b015f4eb929c75f2af564299}{y}}, size.x, 0.f, color);}
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00107}00107         addVertex(pos.\mbox{\hyperlink{classsf_1_1_vector2_a1e6ad77fa155f3753bfb92699bd28141}{x}} + half.\mbox{\hyperlink{classsf_1_1_vector2_a1e6ad77fa155f3753bfb92699bd28141}{x}}, pos.\mbox{\hyperlink{classsf_1_1_vector2_a420f2481b015f4eb929c75f2af564299}{y}} + half.\mbox{\hyperlink{classsf_1_1_vector2_a420f2481b015f4eb929c75f2af564299}{y}}, size.x, size.y, color);}
\DoxyCodeLine{\Hypertarget{_week11_2_week11-_demo5-_particle_2_source_2_particle_node_8cpp_source_l00108}00108         addVertex(pos.\mbox{\hyperlink{classsf_1_1_vector2_a1e6ad77fa155f3753bfb92699bd28141}{x}} -\/ half.\mbox{\hyperlink{classsf_1_1_vector2_a1e6ad77fa155f3753bfb92699bd28141}{x}}, pos.\mbox{\hyperlink{classsf_1_1_vector2_a420f2481b015f4eb929c75f2af564299}{y}} + half.\mbox{\hyperlink{classsf_1_1_vector2_a420f2481b015f4eb929c75f2af564299}{y}}, 0.f, size.y, color);}
