    ...
    int blurCount)
{
    ...
    auto transition1 = CD3DX12_RESOURCE_BARRIER::Transition(mAmbientMap0.Get(),
    ...
    auto transition2 = CD3DX12_RESOURCE_BARRIER::Transition(mAmbientMap0.Get(),
...
void Ssao::BlurAmbientMap(ID3D12GraphicsCommandList* cmdList, bool horzBlur)
{
    ...
    auto transition1 = CD3DX12_RESOURCE_BARRIER::Transition(output,
        D3D12_RESOURCE_STATE_GENERIC_READ, D3D12_RESOURCE_STATE_RENDER_TARGET);
    cmdList->ResourceBarrier(1, &transition1);
    ...
    auto transition2 = CD3DX12_RESOURCE_BARRIER::Transition(output,
        D3D12_RESOURCE_STATE_RENDER_TARGET, D3D12_RESOURCE_STATE_GENERIC_READ);
    cmdList->ResourceBarrier(1, &transition2);
}
...
void Ssao::BuildResources()
{
    ...
    auto properties2 = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT);
    ThrowIfFailed(md3dDevice->CreateCommittedResource(
        &properties2,
        D3D12_HEAP_FLAG_NONE,
        &texDesc,
    ...
    auto properties3 = CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_DEFAULT);
    ThrowIfFailed(md3dDevice->CreateCommittedResource(
        &properties3,
        D3D12_HEAP_FLAG_NONE,
        &texDesc,
...
void Ssao::BuildRandomVectorTexture(ID3D12GraphicsCommandList* cmdList)
{
    ...
    auto transition1 = CD3DX12_RESOURCE_BARRIER::Transition(mRandomVectorMap.Get(),
    ...
    auto transition2 = CD3DX12_RESOURCE_BARRIER::Transition(mRandomVectorMap.Get(),
