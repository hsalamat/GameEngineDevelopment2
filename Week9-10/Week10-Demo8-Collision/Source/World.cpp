...
void World::handleCollisions()
{
	...
	for (SceneNode::Pair pair : collisionPairs)
	{
		...
		//Want to intercept enemy missile - add a case for Category::AlliedProjectile and Category::EnemyProjectile
		//Want to allow friendly fire and see enemy planes taking each other down - add a case for Category::EnemyAircraft and Category::EnemyAircraft
	}
}

void World::destroyEntitiesOutsideView()
{
	//remove entities that are located outside the view.
	//getBattlefieldBounds() is slightly bigger than getViewBounds
	Command command;
